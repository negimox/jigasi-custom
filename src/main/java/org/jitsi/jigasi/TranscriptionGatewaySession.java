...
import org.jitsi.jigasi.transcription.tts.*;
import org.jitsi.jigasi.transcription.TranslationPlaybackManager;
               ...
               TranslationResultListener
{
    ...
    /**
     * Prototype playback manager that requests TTS audio for translations.
     */
    private TranslationPlaybackManager playbackManager;
                                       ...
                                       TranscriptHandler handler)
    {
        ...
        // Instantiate the playback manager prototype which will request TTS audio
        // for translation results and write files to /tmp for verification.
        try
        {
            this.playbackManager = new TranslationPlaybackManager();
            this.transcriber.addTranslationListener(this.playbackManager);
        }
        catch (Throwable t)
        {
            this.logger.warn("Could not initialize TranslationPlaybackManager: " + t);
        }
    ...
    Exception onConferenceCallStarted(Call jvbConferenceCall)
    {
        ...
        // Inform playback manager about the active jvb call so it can inject audio
        try
        {
            TranslationPlaybackManager.setJvbCall(this.jvbCall);
        }
        catch (Throwable t) { }
